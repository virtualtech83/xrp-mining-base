    ...
    <div className="space-y-6" data-testid="referral-page">
      <div>
        ...
        <p className="text-gray-400">
          Invite friends and earn 10 XRP per referral
        </p>
      </div>
      ...
      <div className="glass-card p-6">
        ...
        {loading ? (
          <p className="text-gray-400" data-testid="loading-referrals">
            Loading...
          </p>
              ...
              >
                <div>
                  <p
                    ...
                    data-testid="referred-user-email"
                  >
                    {referredUser.email}
                  </p>
                  <p className="text-gray-400 text-xs mt-1">
                    Joined: {formatDate(referredUser.joined_at)}
                  </p>
                </div>
          ...
          <p className="text-gray-400" data-testid="no-referrals">
