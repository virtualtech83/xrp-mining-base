...
export default function HistoryPage() {
  ...
  const getTotalEarned = () => {
    return sessions.reduce(
      (sum, session) => sum + (session.xrp_earned || 0),
      0
    );
  };
    ...
    <div className="space-y-6" data-testid="history-page">
      <div>
        ...
        <p className="text-gray-400">
          View all your completed mining sessions
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-card p-6" data-testid="total-sessions-card">
          ...
          <p className="text-gray-400 text-sm mt-1">
            {getTotalTime().toFixed(1)} minutes mined
          </p>
        </div>
      ...
      <div className="glass-card p-6">
        ...
        {loading ? (
          <p className="text-gray-400" data-testid="loading-history">
            Loading...
          </p>
        ) : sessions.length > 0 ? (
              ...
              >
                ...
                <div className="text-left md:text-right">
                  ...
                  <p className="text-gray-400 text-xs mt-1">
                    Rate:{' '}
                    {(
                      (session.xrp_earned / session.duration_minutes) *
                      60
                    ).toFixed(4)}{' '}
                    XRP/hr
                  </p>
          ...
          <p className="text-gray-400" data-testid="no-sessions">
            No mining sessions yet. Start mining to build your history!
          </p>
        )}
      </div>
    </div>
