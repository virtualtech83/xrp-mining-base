        ...
        <div className="glass-card p-6" data-testid="withdrawal-form-card">
          ...
          <form onSubmit={handleWithdrawal} className="space-y-4">
            ...
            <button
              ...
              className="w-full px-6 py-4 bg-primary text-white font-bold uppercase tracking-wider hover:bg-blue-600 transition-all duration-300 border border-blue-400/30 neon-glow disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
