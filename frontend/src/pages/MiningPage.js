...
export default function MiningPage() {
  ...
  const handleStartMining = async () => {
    try {
      ...
      toast.error(
        error.response?.data?.detail || 'Failed to start mining'
      );
    }
  };
  ...
  const handleStopMining = async () => {
    try {
      ...
      toast.error(
        error.response?.data?.detail || 'Failed to stop mining'
      );
    }
  };
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="glass-card p-4 sm:p-6" data-testid="hashrate-card">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="font-unbounded font-bold text-white text-sm sm:text-base">
              Hash Rate
            </h3>
          </div>
          <p
            className="text-2xl sm:text-3xl font-mono font-bold text-primary"
            data-testid="hashrate-value"
          >
        ...
        <div className="glass-card p-4 sm:p-6" data-testid="session-time-card">
          ...
          <p
            ...
            data-testid="session-time-value"
          >
        ...
        <div
          className="glass-card p-4 sm:p-6 sm:col-span-2 lg:col-span-1"
          data-testid="accumulated-xrp-card"
        >
          <div className="flex items-center gap-3 mb-3">
          ...
          <p
            className="text-2xl sm:text-3xl font-mono font-bold text-accent"
            data-testid="accumulated-xrp-value"
          >
      ...
      {mining && (
        <div className="glass-card p-4 sm:p-6 bg-primary/10 border-primary/30">
          <p
            ...
            data-testid="mining-tip"
          >
            <span className="font-bold">Tip:</span> The longer you mine, the
            higher your rewards! Mining rate increases over time.
          </p>
        </div>
      )}
    </div>
